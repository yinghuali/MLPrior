...
ap.add_argument("--path_mutation_models", type=str)
...
path_mutation_models = args.path_mutation_models
...
# python mlprior_tree.py --path_data 'data/bank.csv' --model_name 'rf' --path_target_model 'models/target_models/bank_rf.model' --path_mutation_models 'models/mutation_models/bank/rf' --mutation_cols_level 5 --n_mutants_data 10 --label_name 'y'
